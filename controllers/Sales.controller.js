...
//             ctx.fillText(
//                 `${productDetail.sku} x${productDetail.quantitySold} - ₹${productDetail.totalAmount.toFixed(2)}`,
//                 20,
//                 yPosition
//             );
//             yPosition += 30;
...
//         const outputPath = path.join(__dirname, '../public/barcodes', `receipt_${sale._id}.png`);
...
//             totalSaleAmount,
//             sale,
//             receiptPath: `/public/barcodes/receipt_${sale._id}.png`,
//         });
//     } catch (error) {
